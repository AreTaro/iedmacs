...
1. Cliquer sur le lien "Rédiger un devoir avec l'IEDmacs", et enregistrer le document sous le chemin et le nom de votre choix avec la commande `Ctrl-x Ctrl-s`.
