...
% J'ai choisi la police Noto car je la trouve simple et élégante,
% mais si vous préférer un autre police ajouter supprimer ou
% ajouter le symbole % en début de ligne, et enlever celui de la
% ligne suivante pour réactiver lmodern
#+LATEX_HEADER: \usepackage{noto}
#+LATEX_HEADER: \renewcommand{\sfdefault}{phv} % Noto Sans
